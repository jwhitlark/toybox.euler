...
(defn double-palindrome [x]
  (and (palindromic (str x))
       (palindromic (->binary x))))

(defn solve [x]
  (time (reduce + (filter double-palindrome (range 1 x)))))

;; euler.problem36> (solve 1000000)
;; "Elapsed time: 789.104 msecs"
;; 872187
